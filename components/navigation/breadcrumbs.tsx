...
export function Breadcrumbs({ 
  ...
  return (
    <header className="flex h-16 z-50 shrink-0 sticky top-0 items-center gap-2 border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
